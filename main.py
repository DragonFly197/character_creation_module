""".
This project is a simple game in which
You choose a person among a warrior, a mage, a healer.
The author of this docstring is
Evgeniy Kalyuzhnyy, e.kalyuzhnyy@inbox.ru.
"""
